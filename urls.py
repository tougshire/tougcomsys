...
urlpatterns = [
    ...
    path('article/_/<int:pk>/articleeventdates/', views.ArticleArticleEventDates.as_view(), name='article_articleeventdates'),
    path('article/_/<int:pk>/placements/', views.ArticlePlacements.as_view(), name='article_placements'),
