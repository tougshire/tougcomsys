...
urlpatterns = [
    ...
    path('_/article/update/<int:pk>/', views.ArticleUpdate.as_view(), name='article_update'),
    ...
    path('_/article/list/', views.ArticleList.as_view(), name='article_list'),
    path('_/article/<int:pk>/articleeventdates/', views.ArticleArticleEventDates.as_view(), name='article_articleeventdates'),
    path('_/article/<int:pk>/placements/', views.ArticlePlacements.as_view(), name='article_placements'),
